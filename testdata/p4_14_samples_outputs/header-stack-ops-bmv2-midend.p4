...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    apply {
        ...
        if (meta._m_op0 == 8w0x0) {
            ;
        } else if (meta._m_op0 >> 4 == 8w1) {
            if (meta._m_op0 & 8w0xf == 8w1) {
                _op1_t_push.apply();
            } else if (meta._m_op0 & 8w0xf == 8w2) {
                _op1_t_push_0.apply();
            } else if (meta._m_op0 & 8w0xf == 8w3) {
                _op1_t_push_1.apply();
            } else if (meta._m_op0 & 8w0xf == 8w4) {
                _op1_t_push_2.apply();
            } else if (meta._m_op0 & 8w0xf == 8w5) {
                _op1_t_push_3.apply();
            }
        } else if (meta._m_op0 >> 4 == 8w2) {
            if (meta._m_op0 & 8w0xf == 8w1) {
                _op1_t_pop.apply();
            } else if (meta._m_op0 & 8w0xf == 8w2) {
                _op1_t_pop_0.apply();
        ...
        } else if (meta._m_op0 >> 4 == 8w3) {
            if (meta._m_op0 & 8w0xf == 8w0) {
                _op1_t_assign_header.apply();
            } else if (meta._m_op0 & 8w0xf == 8w1) {
